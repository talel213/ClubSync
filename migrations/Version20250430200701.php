 ...
 */
final class Version20250430200701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE club CHANGE foundation foundation DATE DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE club CHANGE foundation foundation DATE NOT NULL, CHANGE image image VARCHAR(255) NOT NULL
        SQL);
    }
}
